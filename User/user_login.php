...
<html lang="en">
    ...
    if (!empty($_POST["email"]) && !empty($_POST["pass"])) {
        ...
        $sql2 = "SELECT * FROM admin WHERE email ='$email' AND pass ='$pass'"; //Find the admin acc
        $isFound = mysqli_query($conn,$sql2); //Check is it exists
        ...
        }else if(mysqli_num_rows($isFound) == 1){
